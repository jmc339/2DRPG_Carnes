...
public class PlayerControl : MonoBehaviour {
	...
	private static bool textalready; 
	...
	void Update () {
		...
		if (!move) {
			...
			//if (Input.GetMouseButtonDown (2)) { //Used for 'Sprinting" 
				//while (!Input.GetMouseButtonUp (2)) {  -----This line is making the game freeze. tried getmousemuttonup and down, true and false. 
															//It might  need to have transform.position.x, ...y,...z, to work? 
