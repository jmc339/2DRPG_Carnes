...
//private PlayerLevelUp bar; 
	...
	void Update () {
		...
		HpText.text = "Health Points: " + playerHealthmanager.playerCurrentHealth + "/" + playerHealthmanager.playerMaxHealth; 
		lvltxt.text = "Level: " + Plu.levelcurrently; 
		//Lvlbar.maxValue = bar.nextlevel;  
		//Lvlbar.minValue = bar.xpcurrently; 
